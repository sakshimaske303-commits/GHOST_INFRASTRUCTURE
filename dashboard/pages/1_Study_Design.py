...
render_card("""
    <p style="color:#111111; font-weight:900; font-size:1rem; line-height:1.7; margin:0;">
...
render_card("""
    <p style="color:#111111; font-weight:900; font-size:1.1rem; line-height:1.7; margin:0;">
...
with m1:
    render_card("""
        <p style="color:#111111; font-weight:800; font-size:0.95rem; text-transform:uppercase; margin:0 0 8px 0;">Step 1</p>
...
with m2:
    render_card("""
        <p style="color:#111111; font-weight:800; font-size:0.95rem; text-transform:uppercase; margin:0 0 8px 0;">Step 2</p>
...
with m3:
    render_card("""
        <p style="color:#111111; font-weight:800; font-size:0.95rem; text-transform:uppercase; margin:0 0 8px 0;">Step 3</p>
