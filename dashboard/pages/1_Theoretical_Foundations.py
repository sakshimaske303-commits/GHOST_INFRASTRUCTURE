...
with col_b:
    ...
    card(
        ...
        physical relationship shown was authored by me from my own understanding of anthropogenic
        landform change; the AI was directed to illustrate it, not to originate it.</p>"""
    )
